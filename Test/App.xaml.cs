    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            PublicClientApp = PublicClientApplicationBuilder.Create(ClientId)
                ...
                .WithLogging(Log, LogLevel.Verbose, true,true)
           //  .WithRedirectUri($"https://sundaramapptech.b2clogin.com/oauth2/nativeclient")
                .Build();
        }
        ...
        //private static string Tenant = "snsvms.onmicrosoft.com";
        //private static string ClientId = "980fcfac-0be0-4f4a-ae77-d9baedb0b56d";
        //private static string BaseAuthority = "https://snsvms.b2clogin.com/tfp/{tenant}/{policy}/oauth2/v2.0/authorize";
        //public static string PolicySignUpSignIn = "B2C_1_login";
        //public static string[] ApiScopes = { "" };
